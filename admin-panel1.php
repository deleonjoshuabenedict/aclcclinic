...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> ACLC Online Clinic </a>
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left, #00008b, #00008b);
}
...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%; padding-bottom: 20px;font-family: 'IBM Plex Sans', sans-serif;"> WELCOME TO ADMIN PAGE </h3>
    <div class="row">
